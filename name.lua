    ...
    getgenv().TextChatService.MessageReceived:Connect(function(message) 
        ...
        if sender == "L0CKED_1N1" or sender == "Laylay_4kla" or sender == "CHEATING_B0SS" then
            ...
            if prefix and command then
                ...
                local validCommands = {".bring", ".kill", ".freeze", ".unfreeze", ".users", ".promote", ".jail", ".unjail", ".mute", ".unmute", ".emote", ".nobooth", ".blur", ".unblur", ".hide", ".unhide"}
    ...
    freezeEvent.Event:Connect(function(toggle, player)
        ...
        if targetPlayer and targetPlayer.Character then
            ...
            if humanoidRootPart then
                ...
                warn("HumanoidRootPart not found for player: " .. tostring(player))
            end
        else
            warn("Player or their character not found: " .. tostring(player))
        end
    end)
    wait()
